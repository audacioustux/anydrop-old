      ...
      <div class="flex justify-end">
        <button disable-with="Dropping..."
                class="bg-white inline-flex items-center justify-center whitespace-nowrap rounded-md
                        ...
                        shadow-md ring-1 ring-slate-700/10 bg-white hover:bg-slate-50 active:bg-slate-100
                      "
        >
          <svg class="mr-2 w-6 h-6"  stroke-width="0" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><path d="M1 1.91L1.78 1.5L15 7.44899V8.3999L1.78 14.33L1 13.91L2.58311 8L1 1.91ZM3.6118 8.5L2.33037 13.1295L13.5 7.8999L2.33037 2.83859L3.6118 7.43874L9 7.5V8.5H3.6118Z"></path></svg>
          Drop Now !
        </button>
      </div>
    </.simple_form>
