  ...
  def render(assigns) do
    ~H"""
      <%!-- <div class="px-32 py-10"> --%>
        <main class="grid grid-cols-2 items-start gap-12 max-w-3xl mx-auto p-10">
          <%= for drop <- @drops do%>
            <div class="bg-white flex flex-col rounded-lg shadow-lg p-8">
              ...
              <p class="px-8 py-4 font-semibold italic text-slate-800">
                <%= drop.body
                    |> html_escape()
                    |> safe_to_string()
                    |> String.replace("\n", "<br>")
              ...
              <svg class="self-end w-6 h-6 fill-slate-600" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
